...
```bash
git remote add encore encore://simple-backend-6zs2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/simple-backend-6zs2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/simple-backend-6zs2/settings/integrations/github)
