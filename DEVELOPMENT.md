...
```bash
git remote add encore encore://simple-todo-app-wy4i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/simple-todo-app-wy4i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/simple-todo-app-wy4i/settings/integrations/github)
